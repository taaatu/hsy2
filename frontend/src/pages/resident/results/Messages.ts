export const MESSAGE_1 = `Asumistottumisesi ovat hyvässä kunnossa ja toimit taloyhtiön hyvinvointi mielessä. Toisin sanoen olet taloyhtiön jalokivi, joka antaa esimerkkiä muille asukkaille. 
...
export const MESSAGE_2 = `Asumistottumuksesi ovat hyvässä kunnossa ja toimit usein taloyhtiön hyvinvointi mielessä. Toisin sanoen olet olohuoneen kirjahylly, joka kerää tietoa erinomaisesti.
...
export const MESSAGE_3 = `Asumistottumuksesi ovat kohtuullisessa kunnossa ja toimit toisinaan myös taloyhtiön hyvinvointi mielessä. 
...
export const MESSAGE_4 = `Asumistottumuksesi voisivat kaivata hieman kunnostamista ja toimet taloyhtiön hyvinvointia kohtaan voisi pitää mielessä. 
